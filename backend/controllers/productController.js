...
export const createProductUnit = async (req, res) => {
    try {
        const { name, category, price, image, description, colors, colorImages, sizes, subcategory, styleTag } = req.body;
        ...
        const newProduct = await Product.create({ name, category, price, image, description, colors, colorImages, sizes, subcategory, styleTag, order: nextOrder });
...
export const updateProductUnit = async (req, res) => {
    try {
        const { id } = req.params;
        const { name, category, price, image, description, colors, colorImages, sizes, order, subcategory, styleTag } = req.body;
        const updateData = { name, category, price, image, description, colors, colorImages, sizes, subcategory, styleTag };
